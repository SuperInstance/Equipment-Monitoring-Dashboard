...
exports.CellVisualizer = void 0;
const types_1 = require("./types");
const DEFAULT_CELL_CONFIG = {
    theme: types_1.DEFAULT_THEME,
...
class CellVisualizer {
     ...
     */
    visualizeProvenance(cellId, provenance) {
        const nodes = [];
        const edges = [];
        // Create origin node
    ...
    toHTML() {
        if (!this.grid)
            return '<div>No grid initialized</div>';
        const [width, height] = this.grid.dimensions;
     ...
     */
    toJSON() {
        const statistics = Object.fromEntries(this.getZoneStatistics());
        return {
    ...
    // Private methods
    createCellVisualization(key, tile) {
        ...
        return {
            ...
            zone: (0, types_1.getConfidenceZone)(tile.confidence(null)),
            lastUpdated: Date.now(),
            provenanceDepth: 0,
        };
    }
    cellToVisualization(cell) {
        return {
            cellId: cell.id,
            position: cell.position,
            value: cell.value,
            confidence: cell.confidence,
            zone: (0, types_1.getConfidenceZone)(cell.confidence),
            agentId: cell.agent,
            lastUpdated: Date.now(),
...
exports.CellVisualizer = CellVisualizer;
exports.default = CellVisualizer;
//# sourceMappingURL=CellVisualizer.js.map